...
//        resources = getResources();
        final EditText restaurant_name_ev = (EditText)findViewById(R.id.item2_edit1);
        final EditText waiter_num_ev = (EditText)findViewById(R.id.item2_edit2);
        final Button ok_btn = (Button)findViewById(R.id.item2_ok_btn);
